import { Button, Flex, Heading } from '../../../component'
      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xxl" color="secondary" mb="24px">
            The moon is made of pancakes.          </Heading>
          <Heading scale="md" mb="24px">
            Trade, earn, and win crypto on the most popular decentralized platform in the galaxy.          </Heading>
          <Flex>
          </Flex>
        </Flex>
        <Flex
