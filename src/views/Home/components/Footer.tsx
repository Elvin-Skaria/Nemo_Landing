...
import { Flex, Heading, Text, Link, OpenNewIcon } from '../../../component'
    ...
    <>
      ...
      <Wrapper>
        <Heading mb="24px" scale="xl" color="white">
          Start in seconds.        </Heading>
        <Text textAlign="center" color="white">
          Connect your crypto wallet to start using the app in seconds.        </Text>
        <Text mb="24px" bold color="white">
          No registration needed.        </Text>

        <Link external href="https://docs.pancakeswap.finance/">
          Learn how to start          <OpenNewIcon color="primary" ml="4px" />
        </Link>
      </Wrapper>
    </>
  )
